...
export default function AtbashTool({ toolMeta: _ }: ToolComponentProps) {
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      <div className="flex flex-wrap items-center gap-2">
        <Button size="sm" onClick={run} disabled={!input.trim()}>Apply Atbash</Button>
        ...
        <span className="ml-auto text-xs text-muted-foreground">Symmetric — apply again to reverse</span>
      </div>
