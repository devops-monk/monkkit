...
export default function Base32Tool({ toolMeta: _ }: ToolComponentProps) {
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      ...
      <SplitPane
        left={<CodeEditor value={input} onChange={setInput} language="plaintext" placeholder="Enter text or Base32..." />}
        right={
